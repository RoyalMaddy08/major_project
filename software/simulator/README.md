...
Implemented in [battery_simulator.py](file:///d:/_Deployed_Projects_Vercel/major_project/software/simulator/battery_simulator.py).
...
Where:
- $V_{\text{OCV}}$ is OCV lookup from [battery_chemistry.py](file:///d:/_Deployed_Projects_Vercel/major_project/software/simulator/battery_chemistry.py).
...
Settings are declared in [config.py](file:///d:/_Deployed_Projects_Vercel/major_project/software/simulator/config.py):
